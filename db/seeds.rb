...
Garment.create(brand_id: 1, name: "Havana Trench Coat", url: "https://as1.ftcdn.net/jpg/01/97/44/26/500_F_197442683_ZqvLvKM8mt3keqzXdNHCZ8YNTq4fmJTC.jpg", category: "Outerwear", season: "Cruise 2019", location: "China", status: "1st Stock Sample", fabrication: "100% Cotton Washed Canvas", sizing: "XXS-XXL", measurement: "Body Length From Center Back Neck: 33 inches, Shell Inseam: 12 inches, Pocket: 5 inches, Elbow Patches Placement from shoulder: 2 inches", fit_comment: "Button holes be made 1/8 inch larger, as the Buttons have already been ordered", comment: "Wash approved as per 1st Factory Stock Sample")

Garment.create(brand_id: 2, name: "Dakota Skirt", url: "https://petiterepublic.files.wordpress.com/2010/11/000001753158.jpeg", category: "Bottoms", season: "Spring 2020", location: "Sri Lanka", status: "2nd Stock Sample", fabrication: "Silk Jacquard", sizing: "S-L", measurement: "Body Length From Center Back Neck: 42 inches, Sleeve Opening: 12 inches", fit_comment: "Sleeve Length revised to be 33 1/4 inches", comment: "Please attach all buttons securely. Factory to test each button to ensure functionality")

Garment.create(brand_id: 3, name: "Rio Dress", url: "https://indigorchid.files.wordpress.com/2011/12/boat_dress_flat.jpg", category: "Dresses", season: "Spring 2020", location: "Bangladesh", status: "Showroom Sample", fabrication: "Cotton Poplin", sizing: "XS-XL", measurement: "Armhole Circumference: 16 inches, Across Shoulder: 21 inches, Sleeve Opening: 10 inches", fit_comment: "Reduce across shoulder, across back, and across front as pinned", comment: "Contrast stitching should be in black")

Garment.create(brand_id: 1, name: "Sailor Pants", url: "https://www.lekala.co/files/-r-/models/558/558_technical_drawing_2753.jpg", category: "Bottoms", season: "Cruise 2019", location: "Italy", status: "Showroom Sample", fabrication: "Garment Dyed Twill", sizing: "XS-XL", measurement: "Inseam: 29 inches, Rise: 9 15/16 inches, Back Pocket Width: 3 1/2 inches", fit_comment: "Reduce leg length by 2 inches, move back pockets 3/4 inch to the left", comment: "Contrast stitching should be in gold")
