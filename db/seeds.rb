...
Supplier.create(name: "Buttondowns Forever", location: "Shenzhen, China", map_url: "https://maps.googleapis.com/maps/api/staticmap?center=Shenzhen&zoom=13&scale=1&size=300x450&maptype=roadmap&key=AIzaSyBTd4sjbFbrazbXX0xgF3pYCf-KY1zfM40&format=png&visual_refresh=true", phone: "", employees: 400, established: 1985)
Supplier.create(name: "Pants & All", location: "Blumenau, Brazil", map_url: "https://maps.googleapis.com/maps/api/staticmap?center=Blumenau&zoom=13&scale=1&size=300x450&maptype=roadmap&key=AIzaSyBTd4sjbFbrazbXX0xgF3pYCf-KY1zfM40&format=png&visual_refresh=true", phone: "", employees: 354, established: 1976)
Supplier.create(name: "Wellmade Inc", location: "Dhaka, Bangladesh", map_url: "https://maps.googleapis.com/maps/api/staticmap?center=Dhaka,+Bangladesh&zoom=13&scale=1&size=300x450&maptype=roadmap&key=AIzaSyBTd4sjbFbrazbXX0xgF3pYCf-KY1zfM40&format=png&visual_refresh=true", phone: "", employees: 58, established: 2004)
Supplier.create(name: "XYZippers", location: "Los Angeles, USA", map_url: "https://maps.googleapis.com/maps/api/staticmap?center=Los+Angeles&zoom=13&scale=1&size=300x450&maptype=roadmap&key=AIzaSyBTd4sjbFbrazbXX0xgF3pYCf-KY1zfM40&format=png&visual_refresh=true", phone: "", employees: 145, established: 2001)
...
Garment.create(brand_id: 1, name: "Havana Trench Coat", url: "https://1.bp.blogspot.com/-zGQbJu7Ov1Y/WcrvEflg4aI/AAAAAAAAUYo/jT8oahdtd9UGum6TPjdWCPSnv_18vX_qwCLcBGAs/s1600/%25EF%25BB%25BFTrench%2BCoat%2Bwith%2BPlaid%2BLining%2B0169.png", category: "Outerwear", season: "Cruise 2019", rate: 1, location: "China", status: "1st Stock Sample", fabrication: "100% Cotton Washed Canvas", sizing: "XXS-XXL", measurement: "Body Length: 33 1/2, Shell Inseam: 12 5/6, Pocket: W: 5 x H: 2, Elbow Patches Placement from shoulder: 2 1/2", fit_comment: "Button holes to be made 1/8 inch larger, as the Buttons have already been ordered", comment: "Wash approved as per 1st Factory Stock Sample")
...
Material.create(supplier_id: 1, name: "Corozo Button", item_number: "1234", category: "Trim", size: "", quantity: 1, color: "Caramel", usage: "At center front, at each cuff", price: "US$0.05", comment: "1 extra button", image_url: "https://content.sparkstone.co.uk/7/1/images/catalog/i/xl_b821-32_l.jpg")
